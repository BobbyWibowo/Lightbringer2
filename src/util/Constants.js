module.exports = {
  ...
  Kills: [
    '@ had thought that they were strong enough to go into the dungeon of the 72 hellfires, but unfortunately, they were eradicated on the first level.',
    '@ tried to say their last words… unfortunately, their head flew off before any words could be uttered.',
    '@ with a face that shouted “impossible”, were eradicated from the face of the planet with a mere flick of a demon’s hand.',
    '@ believed that they were strong enough to go against gods. Snorting, a god sent a heavenly beam down towards the ground purging anything related to that heretic.',
    '@ tried to resist the final move of the evil eye requiem but couldn’t even give out a scream before they were overwhelmed.',
    '@ cried out in agony as their flesh was ripped little by little and their body was seared with a torch as they wondered why this was happening. Their eyes were slowly dimming…',
    '@ was proud as they ran out from the cave holding its loots, but they didn’t realize the two glowing balls of light that seemed to be mocking them in the darkness of the cave as they left. Soon after, there was nothing left of them except a small fly flying above the golden statue.',
    'Cursing, @ ran towards the opponent when suddenly, the floor gave out and revealed a pit of piranhas waiting to bite the flesh and intestines of their human body…',
    'Using a final trump card move of @, they felt relieved as they saw the dimensional collapse ball of deep abyss stricking the opponent. Right after, a body burst into pulp and a head with a relaxed smile flew towards a man smiling, unharmed in the crater created by the explosion.',
    'Horrified, @ tried to run away only to find that their two legs were gone and in the mouth of the monstrocity. Before they could even scream, their fingers were gone. After that, it was the arms\u2026 then the body\u2026 then finally, the head with the last expression the victim always made\u2026 one of pure agony and utter terror.'
  ]
}
